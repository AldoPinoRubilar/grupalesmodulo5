...
<html>
    ...
    <body>
        ...
        <section class="w-full px-8 text-gray-700 bg-gradient-to-tl from-indigo-300 to-white">
            <div
        ...
        <div class="max-w-screen-md mx-auto p-5 mt-5">
		  ...
		  xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                <form action="ServletAuth" method="POST" class="w-full" data-aos="fade-right"
                                    data-aos-duration="2000">
                                    <div class="mb-6">
                                        <label
                                            class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                            for="grid-user-name"> Nombre de Usuario </label> <input name="nombreUsuario"
                                            class="appearance-none block w-full md:w-3/4 bg-gray-200 text-gray-700 
				  ...
				  leading-tight focus:outline-none focus:bg-white" id="nombreUsuario" type="text" placeholder="Cosme Fulanito">
                                        <p id="mensajeErrorUsuarioVacio" class="hidden text-red-500 text-xs italic">Por
                                            favor,
                                    ...
                                    <div class="mb-6">
                                        <label
                                            class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                                            for="grid-password"> Clave </label> <input name="claveUsuario" class="appearance-none block w-full md:w-3/4 bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight 
				  focus:outline-none focus:bg-white focus:border-gray-500" id="claveUsuario" type="password" placeholder="****">
                                        <p id="mensajeErrorClaveVacia" class="hidden text-red-500 text-xs italic">Por
                                            favor,
                                            ingrese la clave.</p>
                                    </div>
                        ...
                        <div class="w-full md:w-1/2">
                            <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl"
                                ...
                                <img src="https://i.postimg.cc/gkR2SH03/imgLogin.jpg">
                            </div>
                        </div>
                    </div>
                </div>
