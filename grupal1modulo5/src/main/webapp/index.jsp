<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body>
					...
					<div class="max-w-2xl mb-1">
						...
						<nav
							...
							<div class="container mx-auto flex flex-wrap items-center justify-between">
								...
								<button data-collapse-toggle="mobile-menu" type="button" class="md:hidden ml-1 text-gray-400 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-lg inline-flex items-center justify-center" aria-controls="mobile-menu-2" aria-expanded="false">
								...
								<div class="hidden md:block w-full md:w-auto" id="mobile-menu">
									<ul
										...
										<li>
											<button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 pl-3 pr-4 py-2 md:hover:text-indigo-700 md:p-0 font-medium flex items-center justify-between w-full md:w-auto">Listar
        ...
        xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          ...
          sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
							...
							<div class="relative flex flex-col sm:flex-row sm:space-x-4">
								<a href="#_" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 
            rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto" data-aos="fade-right" data-aos-duration="1000">
		...
		<!-- Section 4 -->
		<section id="acerdaDe" class="py-20 bg-gray-50">
