            ...
            items-center justify-center" aria-controls="mobile-menu-2" aria-expanded="false">
								...
								<div class="hidden md:block w-full md:w-auto" id="mobile-menu">
									<ul
										...
										<li>
											<a href="index.jsp" class="bg-indigo-700 md:bg-transparent text-white block pl-3 pr-4 py-2 md:text-indigo-700 md:p-0 
                rounded focus:outline-none" aria-current="page">Inicio</a>
                    ...
                    font-medium flex items-center justify-between w-full md:w-auto">Crear
											...
											<div id="dropdownNavbar1"
												...
												<ul class="py-1" aria-labelledby="dropdownLargeButton">
													<li>
														<a href="#CrearCapacitacion" onclick="scrollToBottom(event)"
                ...
                block pl-3 pr-4 py-2 md:hover:text-indigo-700 md:p-0">Contacto</a>
										...
										<li>
											<a href="index.html#acercaDe" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 
