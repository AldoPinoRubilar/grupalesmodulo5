                                        ...
                                        <li>
                                            <c:if test="${not empty sessionScope.usuario}">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-white-50 mx-3 my-2"> Bienvenido <span
                                                            class="fw-bold text-capitalize">${sessionScope.usuario}</span>
                                                    </p>
        ...
        xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          ...
          sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                            ...
                            <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                                <a href="crearCapacitacion.jsp" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-indigo-600 
