...
<html>
<head>
	<title>Sitio No Encontrado | Asesorias Grupo 3.</title>
        ...
        <div class="container mx-auto max-w-screen-md p-5">
            <div class="text-center mb-10">
                <div class="text-5xl font-black leading-none text-orange-500 select-none">
                    Lo sentimos<br>
                   Sitio<span class="text-slate-800"> no encontrado.</span>
                </div>
            </div>
            <!-- Boton volver -->
            <div class="flex flex-col items-center mb-9">
                <img src="img/error404.gif" class="w-full max-w-sm mb-4 lg:w-full rounded">
