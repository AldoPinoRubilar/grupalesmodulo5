	...
	<body>    
		...
		<div class="max-w-screen-md mx-auto p-5 mt-5">
			<div class="text-center mb-6">
				...
				<div class="text-4xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900" data-aos="fade-down" data-aos-duration="2000">
			...
			<section id="formLogin" class="px-2 py-10 bg-white md:px-0">
				<div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
					<div class="flex flex-wrap items-center sm:-mx-3">
						<div class="w-full md:w-1/2 md:px-3" data-aos="fade-right" data-aos-duration="2000">
		...
		<a href="#"
			class="flex items-center font-medium text-gray-900 lg:w-auto lg:items-center lg:justify-center md:mb-0" data-aos="fade-up" data-aos-duration="2000">
			<span class="mx-auto text-3xl font-black leading-none text-gray-900 select-none">ASESORIAS<span
					class="text-indigo-600"> GRUPO 3</span></span>
		</a>
