package grupal6modulo5.services;
...
public class CapacitacionService {
	...
	public List<Capacitacion> findAllCapacitaciones() {
		...
		DBConnection conexion = DBConnection.getInstance();
		String sql = "SELECT CONCAT('CAP-', id-1) AS identificador, nombrecapacitacion, rutcliente, dia, hora, lugar, duracion, cantidadasistentes FROM capacitaciones;";
